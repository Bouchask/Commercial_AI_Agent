...
class PromptEngineerAgent:
    def __init__(self, router: ModelRouter):
        ...
        - CONVERSATIONAL REFERENCES: If the user refers to items discussed in the previous turn (e.g. "these 5 services", "the options you listed"), you MUST read the 'Previous Context' carefully and extract ALL those specific services into the 'requirements' array as separate items. Do NOT collapse them into a single generic item.
        ...
        - Use actual catalogue codes returned by tool descriptions if possible, for example: WEB-SHOW, WEB-ECOMM, APP-MOB, UI-UX, SEO-OPT, MAINT-12, HOST-12, MGT-COMM, CONSULT, AUDIT-IT.
